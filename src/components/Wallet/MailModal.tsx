...
const Main = observer(() => {
  ...
  const submit = async () => {
    ...
    try {
      const res = await VaultApi.verifyMailCode({
        email: state.mail,
    ...
    <div className="p-8 w-full md:w-[340px] box-border">
      ...
      <div className="pt-5 px-4">
        <TextField
          label={lang.email}
          value={state.mail}
          onChange={(e) => { state.mail = e.target.value; }}
          variant="outlined"
          fullWidth
          margin="dense"
          autoFocus={isPc}
        ...
        <div className="relative">
          ...
          <div
            className={classNames({
              'text-blue-400 cursor-pointer opacity-100': !state.countdown && state.mail,
      ...
      <div className="flex justify-center">
        <Button
          disabled={!state.mail || !state.code}
